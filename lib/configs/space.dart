...
class Space {
  ...
  static void init() {
    ...
    forDialog = AppDimensions.size!.width > 1550
        ? EdgeInsets.symmetric(
            horizontal: AppDimensions.space(28),
            vertical: AppDimensions.space(7))
        : AppDimensions.size!.width > 1350
            ? EdgeInsets.symmetric(
                horizontal: AppDimensions.space(18),
                vertical: AppDimensions.space(5))
            : AppDimensions.size!.width > 1250
                ? EdgeInsets.symmetric(
                    horizontal: AppDimensions.space(15),
                    vertical: AppDimensions.space(5))
                : EdgeInsets.symmetric(
                    horizontal: AppDimensions.space(13),
                    vertical: AppDimensions.space(5));
